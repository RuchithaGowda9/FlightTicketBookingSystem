package com.crimsonlogic.flightticketbookingsystem.config;
...
@ComponentScan("com.crimsonlogic.flightticketbookingsystem")
@EnableJpaRepositories(basePackages = "com.crimsonlogic.flightticketbookingsystem.repository")
public class AppPersistentContext {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		lcmfb.setPackagesToScan(new String[] { "com.crimsonlogic.flightticketbookingsystem.entity" });

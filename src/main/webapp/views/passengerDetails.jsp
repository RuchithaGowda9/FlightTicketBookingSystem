...
<body>
    ...
    <c:forEach var="passenger" items="${passengerDetailsList}" varStatus="status">
        <fieldset class="border p-4 mb-4">
            ...
            <div class="form-group">
                <label for="firstName${status.index}">First Name</label>
            ...
            <div class="form-group">
                <label for="passportNumber${status.index}">Passport Number</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            function validateIndianPassport(passportNumber) {
                // Indian passport number validation: Should be 8 or 9 alphanumeric characters
                const passportRegex = /^[A-Z]{1}[A-Z0-9]{7,8}$/;
            ...
            function validateForm() {
                ...
                document.querySelectorAll('input, select').forEach(function(field) {
                    ...
                    if (field.required && !field.value.trim()) {
                        errorElem.textContent = "This field is mandatory.";
                        isValid = false;
                    } else {
                        errorElem.textContent = "";
                    }

                    if (id.startsWith('passportNumber') && !validateIndianPassport(field.value.trim())) {
                        document.getElementById(`${id}Error`).textContent = "Invalid passport number. It should be 8 or 9 alphanumeric characters.";
                        isValid = false;
                    }
                });
                return isValid;

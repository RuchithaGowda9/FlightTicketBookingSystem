...
<head>
    <meta charset="UTF-8">
    <title>User Dashboard - Search Flights</title>
    ...
    <style>
        html, body {
            ...
            background: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url('https://assets.newatlas.com/dims4/default/2a36987/2147483647/strip/true/crop/1578x1052+0+14/resize/1200x800!/quality/90/?url=http%3A%2F%2Fnewatlas-brightspot.s3.amazonaws.com%2Farchive%2Fcloud-streamer-2.jpg');
        ...
        .navbar {
            background-color: #2a52be; /* Match the Admin Dashboard navbar color */
            color: #ffffff; 
        }
...
<nav class="navbar navbar-expand-lg navbar-dark">
    <a class="navbar-brand" href="${pageContext.request.contextPath}/user/userdashboard"> 
    ...
    <div class="container">
        <br><br><br>
        <h2 class="heading">Welcome back, ${user.firstName}! Feeling adventurous?</h2>    
        ...
        <form action="${pageContext.request.contextPath}/flight/searchflights" method="post">
            <div class="booking-card">    
                <div class="form-group">
                    ...
                    <select class="form-control" id="from" name="from" required>
                        <c:forEach var="airport" items="${airports}">
                            <option value="${airport.airportId}">${airport.airportCode} - ${airport.city}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="departureDate" name="departureDate" min="<%= new java.text.SimpleDateFormat("yyyy-MM-dd").format(new java.util.Date()) %>" onchange="validateDate(this)">
                </div>
                <div class="form-group">

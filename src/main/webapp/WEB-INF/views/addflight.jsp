...
<body>
    <div class="container mt-5">
        ...
        <form action="${pageContext.request.contextPath}/flight/add" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="departureAirport" name="departureAirport" class="form-control" required>
            </div>

            <div class="form-group">
                <label for="arrivalAirport">Arrival Airport:</label>
                <input type="text" id="arrivalAirport" name="arrivalAirport" class="form-control" required>
            </div>
